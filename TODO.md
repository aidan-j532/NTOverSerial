...
- Add Check to make sure proper usb device is selected, avoid changing drivers for the xbox controllers (it kinda works, it only chagnes the driver for Android devices, and require you to say yes to cahgning the devices driver)
